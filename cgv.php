...
<div class="container" style="text-align:center">
    <div class="row">
        <h1 class="text" style="margin-top: 20px;">Condition Générale de Vente </h1>

            <div class="col-md-12">      
              <p class="text">Conditions générales de vente
              THE VISIT CARD,
              41 Rue Creuzet, Lyon,
              Au Capital Social de 3000€, Immatriculée au RCS le 12-11-2020, sous le numéro SIRET 890910573,
              Représentée par M Bilal BENYAHIA en qualité de Président, dûment habilité aux fins des présentes.

              La société peut être jointe par email en cliquant sur le formulaire de contact accessible via la page d’accueil du site ou par téléphone au +33 6 44 87 43 21
            </p>

            <p class="text"> PREAMBULE

              Le Vendeur est éditeur de Produits et Services de carte connectée à destination de consommateurs, commercialisés par l’intermédiaire de son site Internet (https://www.thevisitcard.com/). La liste et le descriptif des biens et services proposés par la Société peuvent être consultés sur le site susmentionnés.
            </p>
              <p class="text">
              Article 1 : Les conditions générales de vente décrites ci-après détaillent les droits et obligations de la société THE VISIT CARD (SAS) et de son client dans le cadre de la vente des marchandises suivantes : Carte connectée.
              Toute prestation accomplie par la société THE VISIT CARD (SAS) implique donc l'adhésion sans réserve de l'acheteur aux présentes conditions générales de vente.
              </p>

              <p class="text">
              Article 2 : Dispositions générales
              Les présentes Conditions Générales de Vente (CGV) régissent les ventes de Produits ou de Services, effectuées au travers des sites Internet de la Société, et sont partie intégrante du Contrat entre l’Acheteur et le Vendeur.
              Elles sont pleinement opposables à l’Acheteur qui les a acceptés avant de passer commande.
              ...
              Les CGV applicables alors sont celles étant en vigueur à la date du paiement (ou du premier paiement en cas de paiements multiples) de la commande. Ces CGV sont consultables sur le site Internet de la Société à l’adresse suivante : https://www.thevisitcard.com  .
              ...
              Pour tous les produits expédiés hors Union européenne et/ou DOM-TOM, le prix est calculé hors taxes automatiquement sur la facture.
              ...
              Le cas échéant, les règles professionnelles et commerciales auxquelles l’auteur de l’offre entend se soumettre sont consultables dans la rubrique “règles annexes” des présentes CGV, consultables sur le site du Vendeur à l’adresse suivante : 
              ...
              Le prix de vente du produit est celui en vigueur indiqué au jour de la commande, celui-ci ne comportant par les frais de ports facturés en supplément.
              ...
              Le remboursement peut être demandé de la manière suivante : Envoyer un mail ou nous contacter par téléphone au +33 6 44 87 43 21 .
              Le remboursement se fera après une analyse de la situation dans les 7 jours après la réception de la demande .
              Garantie commerciale : La garantie couvre les défauts de fabrication constatés sur votre produit pendant 1 an. 
              Notre garantie ne couvre pas les dommages causés par des accidents ou des modifications non autorisées.
              </p>
              ...
              Les produits sont livrés à l’adresse de livraison qui a été indiquée lors de la commande et dans les délais indiqués.
              Ces délais ne prennent pas en compte le délai de préparation de la commande. Lorsque la livraison nécessite une prise de rendez-vous avec le Client, un contact sera demandé.
              Lorsque le Client commande plusieurs produits en même temps ceux-ci peuvent avoir des délais de livraison différents acheminés.
              En cas de retard d’expédition, le client dispose de la possibilité de nous contacter.
              ...
              France Métropolitaine, Monaco,Belgique,Luxembourg et Suisse.
              Livraison sous 4-7 jours ouvrés, exceptionnellement les livraisons peuvent être retarder.
              Reste de l’UE
              Livraison sous 3-15 jours ouvrés, exceptionnellement les livraisons peuvent être retarder.
              </p>
              ...
              Le Client peut effectuer le règlement par carte bancaire ou PAYPAL. Les cartes émises par des banques domiciliées hors de France doivent obligatoirement être des cartes bancaires internationales (Mastercard ou Visa).
              Le paiement sécurisé en ligne par carte bancaire est réalisé par notre prestataire de paiement.
              Les informations transmises sont chiffrées dans les règles de l’art et ne peuvent être lues au cours du transport sur le réseau (décrire le process).
              Une fois le paiement lancé par le Client, la transaction est immédiatement débitée après vérification des informations.
              Conformément aux dispositions du Code monétaire et financier, l’engagement de payer donné par carte est irrévocable.
              ...
              <p class="text">
              Article 11 : Délai de rétractation Conformément aux dispositions de l’article L 221-5 du Code de la consommation, l’Acheteur dispose du droit de se rétracter sans donner de motif, dans un délai de quatorze (14) jours à la date de réception de sa commande. Le droit de rétractation peut être exercé en contactant la Société de la manière suivante : Par E-Mail ou par téléphone.
              Nous informons les Clients que conformément aux dispositions des articles L. 221-18 à L. 221-28 du Code de la consommation, ce droit de rétractation ne peut être exercé pour (décrire les biens non sujets à ces dispositions). En cas d’exercice du droit de rétractation dans le délai susmentionné, le prix du ou des produits achetés et les frais d’envoi seront remboursés, les frais de retour restant à la charge du Client.
              ...
              Conformément aux dispositions légales, vous trouverez ci-après le formulaire type de rétractation à nous adresser à l’adresse suivante : contact@thevisitcard.com.
              Procédure de remboursement : Nous contacter par le formulaire de contact.
              </p>

              <p class="text">
              Article 12 : Garanties
              Conformément à la loi, le Vendeur assume les garanties de conformité et relative aux vices cachés des produits. Le Vendeur rembourse l’acheteur ou échange les produits apparemment défectueux ou ne correspondant pas à la commande effectuée.
              La demande de remboursement doit s’effectuer de la manière suivante :  Nous contacter par le formulaire de contact.
              Le Vendeur rappelle que le consommateur : – dispose d’un délai de 1 ans à compter de la délivrance du bien pour agir auprès du Vendeur – qu’il peut choisir entre le remplacement et la réparation du bien sous réserve des conditions prévues par les dispositions susmentionnées.
              ...
              Le cas échéant, l’Acheteur peut présenter toute réclamation en contactant la société au moyen des coordonnées suivantes : Nous contacter par le formulaire de contact ou par téléphone.
