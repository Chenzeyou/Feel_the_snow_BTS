...
<div class="container">
	<div class="row">
		...
		<div  class="col designform">	
				...
				<form action="registercard.php" method="post" autocomplete="off" enctype="multipart/form-data">
						...
						<div class="input-group mb-3 justify-content-center">
							<input type="text" name="entreprise" placeholder="entreprise" id="entreprise" required>
						</div>
